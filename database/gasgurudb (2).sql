...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 01, 2019 at 10:21 AM
...
(4, 'YUSUF', 'KIPROP', 'yusufkiprop97@gmail.com', '0724206400', '$2y$10$5dQf/VHJqREb.igEghEVkeE.ICxm1lLB2ywfE0OltV5ATuG9ASFQC', '1571727384');
...
--
ALTER TABLE `tbl_companies`
  ADD CONSTRAINT `tbl_companies_ibfk_1` FOREIGN KEY (`merchant_id`) REFERENCES `tbl_merchants` (`id`);

--
-- Constraints for table `tbl_orders`
--
ALTER TABLE `tbl_orders`
  ADD CONSTRAINT `tbl_orders_ibfk_1` FOREIGN KEY (`client_id`) REFERENCES `tbl_clients` (`id`),
  ADD CONSTRAINT `tbl_orders_ibfk_2` FOREIGN KEY (`size_id`) REFERENCES `tbl_size` (`id`),
  ADD CONSTRAINT `tbl_orders_ibfk_3` FOREIGN KEY (`brand_id`) REFERENCES `tbl_brand` (`id`),
  ADD CONSTRAINT `tbl_orders_ibfk_4` FOREIGN KEY (`location_id`) REFERENCES `locations` (`id`);
