...
<div class="steps">
<h1 style="color:#a88beb;" class="title is-3 has-text-left">Order confirmed successfullly <i class='fa fa-check-circle'></i></h1>

<p class="help is-info has-text-left">* You may call your merchant to facilitate delivery</p>

<div style="border:1px solid #a88beb;" class="box">
    <p class="has-text-left"><span class="has-text-weight-semibold">ORDER <sup>NO</sup>&nbsp; </span>675767</p>
    ...
    <p class="has-text-left"><span class="has-text-weight-semibold">CONTACT PHONE: </span>0724206400</p>	
</div>

   <a class="button is-primary is-pulled-left button-full" href="dashboard.php">BACK TO DASHBOARD</a>
